...
const InputElement = (props) => {
    return (
        <div className={inputElementCSS.form_field}>
            <div className={inputElementCSS.form_field__control}>
                <Field 
                    ...
                    placeholder=" "
                />
                <label htmlFor={props.id} className={inputElementCSS.form_field__label}>{props.label}</label>
